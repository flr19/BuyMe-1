...
<body>
   ...
   // System.out.println("I am an asswhoel"+auction_id);
	...
	str = "SELECT * FROM auction a, product p WHERE a.product_id=p.product_id and (p.color='" + color +"' or p.gender='"+gender+"' or p.category='"+category+"' or p.brand='"+brand+"') and a.start_date >= DATE_ADD(NOW(), INTERVAL -1 MONTH)";
	//ps = con.prepareStatement(str);
